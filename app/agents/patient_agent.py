...
async def run_agent(
    ...
    navigation_stack: list | None = None,
    user_id: str | None = None,
    user_phone: str | None = None,
    routing_tier: str | None = None,
    suggested_specialty: str | None = None,
    specialty_choice_pending: bool = False,
    specialty_choice_options: list | None = None,
    specialty_choice_reason: str | None = None,
    pending_slot_id: str | None = None,
    pending_slot_datetime: str | None = None,
    pending_doctor_name: str | None = None,
    pending_doctor_id: str | None = None,
    pending_specialty: str | None = None,
    ...
    state = AgentState(
        ...
        specialty_choice_pending=specialty_choice_pending,
        specialty_choice_options=specialty_choice_options,
        specialty_choice_reason=specialty_choice_reason,
        pending_slot_id=pending_slot_id,
        pending_slot_datetime=pending_slot_datetime,
        pending_doctor_name=pending_doctor_name,
        pending_doctor_id=pending_doctor_id,
        pending_specialty=pending_specialty,
    ...
    return {
        ...
        "state": {
            ...
            "specialty_choice_pending":   result.get("specialty_choice_pending", False),
            "specialty_choice_options":   result.get("specialty_choice_options"),
            "specialty_choice_reason":    result.get("specialty_choice_reason"),
            "pending_slot_id":            result.get("pending_slot_id"),
            "pending_slot_datetime":      result.get("pending_slot_datetime"),
            "pending_doctor_name":        result.get("pending_doctor_name"),
            "pending_doctor_id":          result.get("pending_doctor_id"),
            "pending_specialty":          result.get("pending_specialty"),
